...
namespace HeartLog.SimpleDbTool.SimpleDbServer
{
    ...
    public class SimpleMysql : ISimpleDbOperation
    {
        ...
        public SimpleMysql(string connecStr)
        {
        ...
        private void PrepareCommand(MySqlCommand cmd, MySqlConnection conn, ref MySqlTransaction trans, bool useTrans, CommandType cmdType, string cmdText, params MySqlParameter[] cmdParms)
        {
        ...
        {
            using (MySqlCommand _sqlCmd = new MySqlCommand())
            {
                try
                {
